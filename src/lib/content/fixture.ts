...
const stats = [
  { value: 24, suffix: "+", label: "Kegiatan terselenggara" },
  { value: 32, suffix: "", label: "Anggota aktif tahun ini" },
  { value: 41, suffix: "", label: "Institusi peserta kompetisi" },
  { value: 27, suffix: "", label: "Project dikerjakan anggota" },
];
