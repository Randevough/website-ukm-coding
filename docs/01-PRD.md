...
- Sistem tema monokrom hangat (_Spec Sheet_) dengan aksen biru kobalt dan oranye.
...
1. **Performa & Audit Web**:
   - Skor Google Lighthouse minimal **90+** untuk _Performance, Accessibility, Best Practices, dan SEO_.
...
3. **Keandalan & Aksesibilitas**:
   ...
   - Mode _prefers-reduced-motion_ menonaktifkan efek animasi berat secara otomatis.
